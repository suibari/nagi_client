...
<div class="callout warn">
	<p>
		<strong>"Kossori" (quiet) posts are not private.</strong> Their bodies stay out of shared timelines,
		but an anonymous Bot-tan summary may appear in "Affirm together." Channel-only posts may be summarized
		in the same way. They are stored in your PDS as ordinary public records, and their text is stored
		on our servers too. Please do not post anything you need to keep secret.
	</p>
</div>

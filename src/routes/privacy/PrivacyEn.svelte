...
<ul>
	...
	<li>
		...
		Bot-tan Radio song selections and DJ comments, and anonymous "Affirm together" summaries. A summary
		is stored with the original post's URI and CID. When the original is a Kossori post, that URI is an
		identifier issued by the Service that contains no author DID, so neither the summary nor a reaction
		to it can be traced back to the author.
	</li>
...
<ul>
	...
	<li>
		To choose songs from recent posts, including kossori posts, and provide your private Bot-tan
		Radio
	</li>
...
<p>
	...
	profile analysis, diaries, card comments, "Affirm together" anonymous summaries, Bot-tan Radio DJ
	comments, and translations are all generated by that model.
</p>
<p>
	<strong>
...
<p>
	For Bot-tan Radio, we research tie-ins, production stories, and collaborators using only the song
...
<div class="table-scroll">
	<table>
		...
		<tbody>
			<tr
				><td>YouTube (radio thumbnail display and video playback)</td><td
					>Access information from your device when a thumbnail appears or you play; post text and
					DID are not sent</td
				></tr
			>
			<tr>
...
<p>
	...
	permission is requested only when you enable crossposting. Editing or deleting a post on Nagi
	updates or removes the matching record, and deleting all of your data from Settings removes them
	as well.
</p>
...
<ul>
	...
	<li>
		AI-generated analysis, diaries, card comments, radio tracks and DJ comments, and anonymous
		summaries
	</li>

<script lang="ts">
	...
	const paths: Record<string, string> = {
		home: 'M3 10.8 12 3.5l9 7.3M5.8 9.2V20h12.4V9.2',
		heart:
			'M12 20.2S4.3 15.6 2.8 10.9C1.7 7.4 4.2 4.5 7.3 4.5c1.9 0 3.4 1 4.7 2.9 1.3-1.9 2.8-2.9 4.7-2.9 3.1 0 5.6 2.9 4.5 6.4C19.7 15.6 12 20.2 12 20.2Z',
		bell: 'M6 9.5a6 6 0 0 1 12 0c0 4.6 1.7 5.8 1.7 5.8H4.3S6 14.1 6 9.5M10.3 19a1.8 1.8 0 0 0 3.4 0',
		bellOff:
			'M6 9.5a6 6 0 0 1 12 0c0 4.6 1.7 5.8 1.7 5.8H4.3S6 14.1 6 9.5M10.3 19a1.8 1.8 0 0 0 3.4 0M4 4l16 16',
		settings: 'M4 21v-6M4 11V3M12 21v-9M12 8V3M20 21v-4M20 13V3M1.5 15h5M9.5 12h5M17.5 17h5',
		user: 'M20 20.5v-1.4a4.6 4.6 0 0 0-4.6-4.6H8.6A4.6 4.6 0 0 0 4 19.1v1.4M12 10.8a3.9 3.9 0 1 0 0-7.8 3.9 3.9 0 0 0 0 7.8Z',
		trash: 'M4 7h16M9 7V4h6v3M7 7l1 14h8l1-14M10 11v6M14 11v6',
		reply: 'M9 8 4 12l5 4v-3h4.5c3.2 0 5.2 1.2 6.5 4-0.2-5.5-2.8-8-7.5-8H9V8Z',
		quote: 'M7 7h4v4H7v5H4v-5c0-2.2 1-3.5 3-4ZM17 7h3v4h-3v5h-3v-5c0-2.2 1-3.5 3-4Z',
		share: 'M8 12v8h11V9h-4M12 15V3M8 7l4-4 4 4',
		download: 'M4 16v3.5h16V16M12 3v12M7.5 10.5 12 15l4.5-4.5',
		...
		blog: 'M3.5 5.5c2.8-.7 5.7.1 8.5 2.3v11.7c-2.8-2.2-5.7-3-8.5-2.3V5.5Zm17 0c-2.8-.7-5.7.1-8.5 2.3v11.7c2.8-2.2 5.7-3 8.5-2.3V5.5Z',
		hide: 'M2 12s3.5-6 10-6c1.7 0 3.2.4 4.5 1M22 12s-3.5 6-10 6c-1.7 0-3.2-.4-4.5-1M4 4l16 16M9.9 9.9a3 3 0 0 0 4.2 4.2',
		warning: 'M12 3 22 21H2L12 3ZM12 9v5M12 18h.01',
		apps: 'M4 4h6v6H4V4Zm10 0h6v6h-6V4ZM4 14h6v6H4v-6Zm10 0h6v6h-6v-6Z',
		edit: 'M4 20h4L18.5 9.5a2 2 0 0 0-2.8-2.8L5 17.2V20ZM14 6l4 4',
		clock: 'M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20ZM12 7v5l3.5 2',
		link: 'M9.5 14.5 14.5 9.5M10.5 6.5 12 5a4 4 0 0 1 6 6l-1.5 1.5M13.5 17.5 12 19a4 4 0 0 1-6-6l1.5-1.5',
		...
		// 重ねた札。ゼンカツ（全肯定カード）の入口に使う。
		cards:
			'M9 7h9v13H9V7Zm-3 3H4.5a1.5 1.5 0 0 0-1.5 1.5V19a2 2 0 0 0 2 2h9M13 11.5l1.5 1.5-1.5 1.5-1.5-1.5 1.5-1.5Z',
		music: 'M9 18V5l11-2v13M9 9l11-2M9 18a3 2 0 1 1-6 0 3 2 0 0 1 6 0ZM20 16a3 2 0 1 1-6 0 3 2 0 0 1 6 0Z',

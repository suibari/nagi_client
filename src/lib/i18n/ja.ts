...
export const ja = {
	...
	newsIntro:
		'botたんが厳選した明るくなるニュースをおとどけします。好きなニュースを投稿することもできます。',
	newsCategoriesAria: 'ニュースのカテゴリ',
	newsCategoryAll: 'すべて',
	newsCategoryRecommended: 'おすすめ',
	newsCategoryEntertainment: 'エンタメ',
	newsCategoryAnimals: '動物',
	newsCategoryFood: 'グルメ',
	newsCategoryTravel: 'おでかけ',
	newsCategorySports: 'スポーツ',
	newsCategoryTechnology: '科学・技術',
	newsRecommendedEmpty: 'あなたにおすすめのニュースはまだありません。',
	...
	communityAffirmationDismiss: '似た投稿を見送る',
	communityAffirmationDismissAria: 'このユーザーによる似た投稿を見送る',
	...
	themeLegend: '表示モード',
	themeHelp: '明るさをシステム設定に合わせるか、ライト／ダークに固定します。',
	themePaletteLegend: 'カラーテーマ',
	themePaletteHelp: 'アクセントと背景の配色を選択します。',
	themePaletteBotMint: 'botミント',
	themePaletteLattePink: 'ラテピンク',
	themePaletteKotomiOrange: 'ことみオレンジ',
	themePaletteMorphoBlue: 'モルフォブルー',
	themePaletteSimple: 'シンプル',
	optionSystem: 'システム設定',
	themeLight: 'ライト',
	themeDark: 'ダーク',
	...
	zenkatsuChiefBadge: '🏆今日のナギカツ部長',
	zenkatsuChiefBadgeAria: '昨日のナギカツで選ばれた人。明日には次の人に移るよ',
	deckCombosTitle: '見つけたコンボ',
	deckCombosProgress: (o: { found: number; total: number }) => `${o.total}種のうち ${o.found}種`,
	deckCombosEmpty: 'まだコンボは見つかっていないよ。組み合わせ次第で何か起きるかも',
	deckComboPioneer: '世界で最初に見つけた！',
	deckComboPioneerBy: (o: { name: string }) => `最初に見つけたのは ${o.name}`,
	deckComboFound: (o: { date: string }) => `${o.date} に発見`,
	deckTrophiesTitle: 'トロフィー',
	deckTrophiesEmpty: 'まだトロフィーはないよ',
	deckCardsTitle: 'カード',
	recordFetchFailed: 'レコードを読み込めませんでした',
	trophyBotan: '今日のナギカツ部長',
	trophyAdventure: '決意のドラ切り賞',
	trophyDebut: '初登板！',
	trophySolo: '単騎待ち！',
	trophyTailwind: '三色同順！',
	trophyCombo: 'コンボ発見賞',
	trophyGuideOpen: '獲得条件を見る',
	trophyGuideTitle: 'トロフィーの獲得条件',
	trophyGuideIntro: 'ナギカツ部長以外の賞は、ゼンカツ！で条件を満たすとすぐに贈られます。',
	trophyBotanDescription:
		'翌朝4時（日本時間）に、botたんがお題と出したカードを見て候補から1人選びます。',
	trophyAdventureDescription: 'SR以上のカードを1枚以上出すと受け取れます。',
	trophySoloDescription: 'カード1枚で答えると受け取れます。',
	trophyTailwindDescription: 'カードを3枚出し、3枚すべてがその日のおすすめ属性なら受け取れます。',
	trophyComboDescription: '世界で初めてコンボを発見した人全員に贈られます。',
	trophyGuideNote: '1回のプレイで複数の賞を受け取ることもあります。',
	zenkatsuTailwindBadge: (o: { n: number }) => `おすすめ属性 ×${o.n}`,
	zenkatsuResultTailwind: 'おすすめ属性',
	zenkatsuResultTailwindNone: 'おすすめ属性は入らなかった。それもまた一手',
	zenkatsuResultTailwindHit: (o: { n: number }) => `${o.n}枚がおすすめ属性だった！`,
	zenkatsuResultCombo: 'コンボ成立！',
	zenkatsuResultComment: 'botたんの総評',
	...
	cardsPageTitle: '全肯定カード',
	cardsTabNews: 'ニュース',
	cardsTabRecord: 'レコード',
	cardsTabCollection: 'マイデッキ',
	...
	zenkatsuPickPrompt: (o: { max: number }) => `手持ちから1〜${o.max}枚えらんでね`,
